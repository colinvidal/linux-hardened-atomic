...
#define HARDENED_ATOMIC_BKPT_IMM "bkpt 0xf1"
#define HARDENED_ATOMIC_BKPT_IMM_ENCODED 0xbef1
#else
#define HARDENED_ATOMIC_BKPT_IMM "bkpt 0xf103"
#define HARDENED_ATOMIC_BKPT_IMM_ENCODED 0xe12f1073
...
#define __POST_OP					\
	"bvc 2f\n"					\
	HARDENED_ATOMIC_BKPT_IMM "\n"		        \
	"2:\n"
#else
#define __POST_OP
#endif /* CONFIG_HARDENED_ATOMIC */

#define __ATOMIC_OP(op, suffix, c_op, asm_op, post_op)		        \
...
#define ATOMIC_OP(op, c_op, asm_op)		                        \
	...
	__ATOMIC_OP(op, , c_op, asm_op##s, __POST_OP)

#define __ATOMIC_OP_RETURN(op, suffix, c_op, asm_op, post_op)           \
...
#define ATOMIC_OP_RETURN(op, c_op, asm_op)	                        \
	...
	__ATOMIC_OP_RETURN(op, , c_op, asm_op##s, __POST_OP)
...
#define __ATOMIC64_OP(op, suffix, op1, op2, post_op)                           \
...
#define ATOMIC64_OP(op, op1, op2)		                        \
	...
	__ATOMIC64_OP(op, , op1, op2##s, __POST_OP)


#define __ATOMIC64_OP_RETURN(op, suffix, op1, op2, post_op)	               \
static inline long long							       \
...
#define ATOMIC64_OP_RETURN(op, op1, op2)				\
	...
	__ATOMIC64_OP_RETURN(op, , op1, op2##s, __POST_OP)
